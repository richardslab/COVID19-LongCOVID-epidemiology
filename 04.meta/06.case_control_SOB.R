...
data$phenotype <- "SOB"
library(meta)
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates == "hospital")
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("age_range50-60"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("age_range70-80"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("age_range>80"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("sexF"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("obesity"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases"  & covariates %in% c("smokingcurrent"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("smokingpast"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("com_asthma"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("com_copd"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("com_hypertension"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("com_diabetes"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("com_autoimmune"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("com_cancer"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "cases" & covariates %in% c("com_dementia"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
write.table(data, file="/home/richards/tomoko.nakanishi/scratch/09.COVID19/08.LongCOVID_epi/SOB.cases.tsv", sep="\t", quote=F, col.names = T, row.names = F)
...
data$phenotype <- "SOB"
library(meta)
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates == "hospital")
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("age_range50-60"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("age_range70-80"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("age_range>80"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("sexF"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("obesity"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls"  & covariates %in% c("smokingcurrent"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("smokingpast"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("com_asthma"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("com_copd"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("com_hypertension"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("com_diabetes"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("com_autoimmune"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("com_cancer"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
tmp <- OUT %>% filter(phenotype == "SOB" & casecontrol == "controls" & covariates %in% c("com_dementia"))
m1 <- metagen(Estimate,
              Std..Error,
              data=tmp,
              studlab=paste(cohort),
...
write.table(data, file="/home/richards/tomoko.nakanishi/scratch/09.COVID19/08.LongCOVID_epi/SOB.controls.tsv", sep="\t", quote=F, col.names = T, row.names = F)


out1 <- fread("/home/richards/tomoko.nakanishi/scratch/09.COVID19/08.LongCOVID_epi/SOB.cases.tsv")
out2 <- fread("/home/richards/tomoko.nakanishi/scratch/09.COVID19/08.LongCOVID_epi/SOB.controls.tsv")
...
png("case_control_SOB.png", width = 700, height = 700)
data1 %>%
  ...
  scale_shape_identity() + ggtitle("Shortness of Breath") + 
  ...
  scale_fill_manual(values=c("#008fd5","#de6b35")) + scale_y_log10(breaks=c(0.1, 0.3, 0.5, 1, 2, 3, 4, 5)) + scale_alpha_discrete(range = c(0.5, 1)) + 
